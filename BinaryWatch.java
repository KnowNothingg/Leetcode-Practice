...
class BinaryWatch{
    ...
    public static List<String> readBinaryWatch(int num){
        ...
        boolean[] used = new boolean[lights.length];
        combination(num,0, used);
        return answer;
    }

    private static void combination(int num, int at, boolean[] used){
        final int N = lights.length;
        int leftToPick = N - at;
        if(leftToPick < num)    return;
